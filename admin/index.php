...
<head>
  ...
  <title>Admin - Portfolio Manager | RK DESIGNS</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .card-body h4 { font-size: 15px; font-weight: 500; margin-bottom: 4px; }
    .card-body p { font-size: 12px; color: #888; margin-bottom: 8px; }
    .card-body .badge { display: inline-block; padding: 2px 10px; background: #f0ede8; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; }
    .card-actions { display: flex; gap: 8px; }
    .card-actions .btn { flex: 1; text-align: center; font-size: 12px; padding: 6px; }
...
<body>
  ...
  <div class="container">
    <div class="add-form">
      ...
      <div class="form-row">
        <input type="text" id="title" placeholder="Title (e.g. Modern Living Room)">
        <input type="text" id="description" placeholder="Description (e.g. Contemporary elegance)">
      </div>
      <div class="form-row">
        <select id="category">
